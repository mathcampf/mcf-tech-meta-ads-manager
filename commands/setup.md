---
description: 'Configure o plugin de Meta Ads: guia o usuário para adicionar o token de acesso e o ID da conta no settings.json, e verifica se a conexão com a API está funcionando.'

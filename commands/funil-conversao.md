---
description: Analisa o funil completo de conversão de e-commerce (impressões → compra) com taxa por etapa, identifica onde o funil está quebrando e se o problema é no anúncio ou no site. Use quando o usuário quer entender as taxas de conversão ou onde está perdendo clientes.
...
1. Escreva o script abaixo em `/tmp/mcf_funil.py`
2. Execute com `python3 /tmp/mcf_funil.py`
3. Delete com `rm /tmp/mcf_funil.py`
4. Apresente a análise do funil com interpretação das taxas de conversão

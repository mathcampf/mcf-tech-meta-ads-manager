---
description: Mostra um dashboard completo de todas as campanhas Meta Ads dos últimos 30 dias — gasto, alcance, frequência, ROAS, alertas por tipo de campanha (funil de vendas, engajamento, tráfego). Use quando o usuário quer uma visão geral, resumo ou diagnóstico inicial da conta.

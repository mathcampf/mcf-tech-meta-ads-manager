---
description: Analisa a performance de cada anúncio (criativo) dentro de uma campanha — vencedor, perdedores, concentração de budget, taxa de conclusão de vídeo e quando inserir novos criativos. Use quando o usuário quer saber quais criativos estão funcionando ou se precisa renovar os anúncios.
